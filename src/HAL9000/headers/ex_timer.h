...
// Returns:      STATUS
// Parameter:    OUT PEX_TIMER Timer - Timer to inbitialize
...
/******************************************
Function:     ExTimerCompareTimers
// Description:  This function is called at each Tick for checking if any of the timers expired 
				 in order to signal the associated ExEvent
// Returns:      void
// Parameter:    void
*******************************************/
void
